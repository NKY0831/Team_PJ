...
<div class="container-fluid">
	...
	<div class="container">
		<div class="jumbotron">
			<h1 class="display-4 text-center">게시글 자세히 보기</h1>
		</div>
		...
		<div class="form-group">
			...
			<div class="form-group row">
				...
				<a onclick="history.back()" class="btn btn-light">뒤로가기</a> &nbsp;
				...
				<a class="btn btn-danger" id="read_btn_updateui">강제 수정</a> &nbsp;
				<a class="btn btn-danger" href="/board/delete_m?bno=${dto.bno}">강제 삭제</a> &nbsp;
				</c:if> 
		...
		<div class="collapse" id="mycollapse">
			<div class="form-group row">
				...
				<input class="form-control" id="read_input_col_id" value="${login.id}" readonly>
			</div>
